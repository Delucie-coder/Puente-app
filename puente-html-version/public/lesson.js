...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const lessons = {
    lang1: { title: 'English: Greetings & Selling Phrases', desc: 'A practical 4-month curriculum with weekly short videos and exercises to practise greetings, prices, and simple negotiations.' },
